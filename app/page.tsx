  ...
  return (
    <>
      ...
      <div className="stats-band"><div className="stats-band-inner">
        ...
        <div className="stat-item fade-in"><div className="stat-lbl" id="stat-best-seg-lbl">Best Segment</div><div className="stat-num" style={{fontSize:'20px',color:'#3ab05a',fontFamily:"'Playfair Display',serif"}} id="stat-best-seg-name">Loading…</div><div className="stat-detail" id="stat-best-seg-record">—</div></div>
      </div></div>
