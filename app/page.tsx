  ...
  return (
    <>
      ...
      <div className="stats-band"><div className="stats-band-inner">
        ...
        <div className="stat-item fade-in"><div className="stat-lbl" id="stat-best-seg-lbl">Best Segment</div><div className="stat-num" style={{color:'#3ab05a'}} id="stat-best-seg-name">Loading…</div><div className="stat-detail" id="stat-best-seg-record" style={{color:'rgba(245,241,230,0.45)'}}>—</div></div>
      </div></div>
